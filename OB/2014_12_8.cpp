...
//いじる数字
#define MOT 1.0e8//MOT原子数
#define n1 1.453
#define r0 0.5e-3//MOT原子郡半径 単位[m]
#define r1 100e-6//開口半径 単位[m]
...
#define gennsui_tyou 519.8643908e-9
...
#define delta (0.7e9*2*M_PI)//レーザー周波数離調[Hz]
#define dt 1.0e-5
