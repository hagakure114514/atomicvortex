...
//===ATTENTION!====================================================================================================================================================
	//THE WRITER OF THIS PROGRAM : K. Kimura (Bachelor 4th grade), THE DATE OF COMPLETION : January 16th, 2019
...
//===Constants that CANNOT be changed==============================================================================================================================
	...
	//#define GNUPLOT_PATH "C:/Users/itolab/Desktop/gnuplot/gnuplot/binary/pgnuplot.exe"	//when booting this program on the labo PC
...
//===Constants that can be changed=================================================================================================================================
	...
	//############# temporary sentence for power loop ########################
		#define min_temp 5.0e-6										//minimum value of when varying branching ratio[-]
		#define max_temp 101.0e-6									//maximum value of when varying branching ratio[-]
		#define d_temp 5.0e-6										//increment of temperature[K]
...
//===Variables for statements, temporary variables=================================================================================================================
	...
	char var_maxbol[20];			//values of variables for file names
	//############# temporary sentence for power loop ########################
	int vara = 5;					//values of variables for file names
	//############# temporary sentence for power loop <end> ##################
...
//===Function Definition (prototype)===============================================================================================================================
	//if you want to see the details of the functions, go to the last part of this program.
	...
	double max_boltz_velo_x(double x, double t);
	double max_boltz_velo_y(double x, double t);
	double max_boltz_velo_z(double x, double t);
...
int main(){
	...
	//===def of variables==========================================================================================================================================
		...
		double temp = 0.0;										//temperature of MOT[K]
		...
		double rad_t = 0.0;										//cylindrical coord.
	...
	//===for loop (repeat changing one variable)===================================================================================================================
		for( temp = min_temp; temp <=max_temp ; temp += d_temp, vara += 5, count++ ){

			//############# temporary sentence for power loop ##################
			sprintf( var, "%duK", vara );
			//############# temporary sentence for power loop <end>#############
			...
			//===generate random no. (initial velocities)==========================================================================================================
				...
				sprintf( fn_rand_maxbol, "../rand_maxbol/%duK_rand_maxbol.csv", vara );
			...
			//===for loop (repeat the number of SAMPLES)===========================================================================================================
				...
				//===initial variables and arrays==================================================================================================================
					...
					//eigenstate
					state_t = state;
				//===initial variables and arrays <end>============================================================================================================
				...
				//===open files for outputting values <end>========================================================================================================
					...
					//===for loop (repeat the number of exporting times)===========================================================================================
						for( int j=1; j<=jloop; j++ ){		
							...
							//===output initial values into csv files==============================================================================================
							...
							//===output initial values into csv files <end>========================================================================================
					...
					//===close csv files if SAMPLE is at the end===================================================================================================
						if( i==SAMPLE ){		//If SAMPLE loop (i loop) is at the end, csv files are closed.
							...
							fclose( f_spon );			fflush( eigenstate );
...
//===Function Definiton============================================================================================================================================
	...
	double max_boltz_velo_x(double x, double t){ //if x=0.15, then random no. between [-0.15[m/s],0.15[m/s]] are generated
		double xi,yj;
		do{
				xi = 2.0*x*rand()/RAND_MAX-x;//generate uniform random no. xi between [-x,x] (x=n*wr/2)
	...
	double max_boltz_velo_y(double x, double t){ //if x=0.15, then random no. between [-0.15[m/s],0.15[m/s]] are generated
		double xi,yj;
		do{
				xi = 2.0*x*rand()/RAND_MAX-x;//generate uniform random no. xi between [-x,x] (x=n*wr/2)
				yj = 12.8*rand()/RAND_MAX;//12.8 is a value that is a little bit greater than the max of max_boltz()
	...
	double max_boltz_velo_z(double x, double t){ //if x=0.15, then random no. between [-0.15[m/s],0.15[m/s]] are generated
		double xi,yj;
		do{
				xi = 2.0*x*rand()/RAND_MAX-x;//generate uniform random no. xi between [-x,x] (x=n*wr/2)
				yj = 12.8*rand()/RAND_MAX;//12.8 is a value that is a little bit greater than the max of max_boltz()
