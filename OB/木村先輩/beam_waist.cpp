...
//===ATTENTION!====================================================================================================================================================
	...
	//### When you change the kind of a beam, change the condition of loss judging, outer radius of the beam and maximum radius of simulation.
...
//===Constants that can be changed=================================================================================================================================
	...
	#define temp 10.0e-6										//initial temperature of MOT[K]
	...
	//############# temporary sentence for power loop ########################
		#define min_waist sigma*3.9*sqrt(2.0)						//minimum value of when varying beam waist[m]
		#define max_waist sigma*5.0*sqrt(2.0)+0.03e-3				//maximum value of when varying beam waist[m]
		#define d_waist sigma*0.1*sqrt(2.0)							//increment of beam waist[m]
	...
	//====depending on variables above====
		...
		#define I_s1 M_PI*h*c*gamma1/(3.0*lambda1*lambda1*lambda1) 	//saturation intensity[W/m^2]
		#define I_s2 M_PI*h*c*gamma2/(3.0*lambda2*lambda2*lambda2) 	//saturation intensity[W/m^2]
...
//===Variables for statements, temporary variables=================================================================================================================
	...
	//############# temporary sentence for beam waist loop ########################
	int vara = 0;						//values of variables for file names
	//############# temporary sentence for beam waist loop <end> ##################
...
int main(){
	...
	//===def of variables==========================================================================================================================================
		...
		double waist = 0.0;										//beam radius[m]
	...
	//===for loop (repeat changing one variable)===================================================================================================================
		for( waist = min_waist; waist <=max_waist; waist += d_waist, vara += 1, count++ ){

			//############# temporary sentence for power loop ##################
				double r_out = 1.50*waist;								//outer radius of beam[m]
				double r_simu = 2.0*waist;								//maximum radius up to which an atom is traced
				double r_judge = waist/sqrt(2.0);						//radius to judge whther an atom is TRAPPED or LOSS (the radius of the peak of TEM)
				double I_0 = power/(M_PI*waist*waist/2.0);				//[W/m^2]
				sprintf( var, "%d.%droot2-sigma", vara/10, vara%10 );
			//############# temporary sentence for power loop <end>#############
